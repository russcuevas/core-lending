        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                @if($role === 'host')
                    ...
                    <a href="{{ route('host.approvals.index') }}" class="nav-link {{ request()->routeIs('host.approvals.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('host.accounts.index') }}" class="nav-link {{ request()->routeIs('host.accounts.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('host.transactions.index') }}" class="nav-link {{ request()->routeIs('host.transactions.*') ? 'active' : '' }}">
                ...
                @elseif($role === 'admin_encoder')
                    ...
                    <a href="{{ route('admin.encoder.dashboard') }}" class="nav-link {{ request()->routeIs('admin.encoder.dashboard') ? 'active' : '' }}">
                        ...
                        <span>Encoder Dashboard</span>
                    </a>
                    <a href="{{ route('admin.encoder.clients.create') }}" class="nav-link {{ request()->routeIs('admin.encoder.clients.create') ? 'active' : '' }}">
                        ...
                        <span>Encode New Client</span>
                    </a>
                    <a href="{{ route('admin.encoder.clients.index') }}" class="nav-link {{ request()->routeIs('admin.encoder.clients.index') ? 'active' : '' }}">
                        <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        <span>Clients Directory</span>
                    </a>
                    <a href="{{ route('admin.encoder.expenses.index') }}" class="nav-link {{ request()->routeIs('admin.encoder.expenses.*') ? 'active' : '' }}">
                        <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        <span>Expenses Tracker</span>
                    </a>
                    <a href="{{ route('admin.encoder.collectors.create') }}" class="nav-link {{ request()->routeIs('admin.encoder.collectors.create') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.encoder.daily_payments') }}" class="nav-link {{ request()->routeIs('admin.encoder.daily_payments') ? 'active' : '' }}">
                ...
                @elseif($role === 'admin_releasing')
                    ...
                    <a href="{{ route('admin.releasing.dashboard') }}" class="nav-link {{ request()->routeIs('admin.releasing.dashboard') ? 'active' : '' }}">
                ...
                @elseif($role === 'collector')
                    ...
                    <a href="{{ route('collector.dashboard') }}" class="nav-link {{ request()->routeIs('collector.dashboard') ? 'active' : '' }}">
                        <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span>Collector Portal</span>
                    </a>
                    <a href="{{ route('collector.scan_qr') }}" class="nav-link {{ request()->routeIs('collector.scan_qr') ? 'active' : '' }}">
            ...
            <div class="sidebar-footer">
                ...
                <form action="{{ route('logout') }}" method="POST" style="margin:0;">
                    @csrf
                    <button type="submit" class="btn btn-sm btn-outline" style="color:#ef4444; border-color:#334155; padding:6px;" title="Logout">
